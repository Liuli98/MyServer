...
void http_process::read_from_connfd()
{
    while (true)
    {
        ...
        {
            close(connfd);
            std::cout<<"Foreigner closed the connecting"<<std::endl;
            break;
        }
        else
        {
...
//返回错误信息
void http_process::clienerror(const char *errnum, const char *shortmsg, const char *longmsg)
{
...
void http_process::process()
{
    ...
    {
        clienerror("501","Not Implented","Server doesn't implement this method");
        return;
    }
    ...
    {
        clienerror("404","Not Found","Server couldn't find this file");
        return;
    }
    ...
    if(is_static)
    {
        ...
        {
            clienerror("403","Forbidden","Server couldn't read the file");
            return;
        }
